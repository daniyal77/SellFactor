<div class="d-none" id="detail-factor">
    <div class="row row-sm">
        <div class="col-12">
            <table class="table mb-1" id="table">
                ...
                <tr>
                    <th></th>
                    <th>{{__('message.description_of_goods_services')}} <span class="text-danger">*</span></th>
                ...
                <tr id="row_table1">
                    <td>
                    <span class="ml-2 mb-2 cu-pointer text-danger" onclick="delete_row(1)">
                        <i class="fa fa-trash" aria-hidden="true"></i>
                    </span>
                    </td>
                    <td id="warehouse_tr_1" class="px-0 position-relative">
                        <select class="js-data-product-ajax form-control" onchange="change_product(this,1)"
                                required="required" data-msg="{{__('message.required')}}"
                                name="factor[1][product]" aria-label="product">
                    ...
                    <td>
                        <input id="count1" onkeyup="totalPriceConverter(1),separateNum(this.value,this);"
                               class="form-control" required="required" data-msg="{{__('message.required')}}"
                               value="1" name="factor[1][count]" aria-label="count">
                    </td>

                    <td class="w-190px">
                        <select class="form-control" onchange="changePrice(1)" id="all_product_price_1"
                                aria-label="all_price">

                        </select>
                    </td>
                    <td>
                        <input id="price1" onkeyup="totalPriceConverter(1),separateNum(this.value,this);"
                               class="form-control" required="required"
                               data-msg="{{__('message.required')}}"
                               value="1" name="factor[1][price]" aria-label="price">
                    </td>
                    <td class="w-100px">
                        <input class="form-control" onkeyup="discount_percent(1)" id="discount_percent1"
                               required="required" data-msg="{{__('message.required')}}"
                               value="0" aria-label="discount_percent">
                    </td>
                    <td>
                        <input class="form-control" name="factor[1][discount]"
                               required="required" data-msg="{{__('message.required')}}"
                               onkeyup="discount_const(1),separateNum(this.value,this);"
                               id="discount_const1" value="0" aria-label="discount_const">
                    </td>
                    <td>
                        <input name="factor[1][total_price]" readonly class="total-price readonly form-control"
                               required="required" data-msg="{{__('message.required')}}"
                               id="total-price1" type="text">
                    </td>
                </tr>
                </tbody>
            </table>
            <span onclick="addRow()" class="btn mb-1 btn-primary btn-sm add-btn">
            ...
            <div class="col-12 col-md-5">
                <table class="table table-bordered">
                        ...
                        <td>
                            <div class="form-group  {{ $errors->has('tax') ? 'has-danger' : '' }}">
                                ...
                                <input onkeyup="separateNum(this.value,this);"
                                       id="tax_all_factor_const" name="tax" readonly
                                       required="required" data-msg="{{__('message.required')}}"
                    ...
                    <tr>
                        ...
                        <td colspan="2"><span id="total_price_factor_done">0</span></td>
                        <input type="hidden" name="total_price" id="total_price_factor_done_hidden">
                    </tr>
                    </tbody>
                </table>
                ...
                <button id="submitBtnPrint" name="print" value="print" class="btn btn-info">ثبت و پرینت</button>
...
@push('script')
    ...
    <script>
        ...
        function discount_percent_total_factor() {
            ...
            $('#discount_all_factor_const').addClass('readonly')
            $('#discount_all_factor').removeClass('readonly')
        }
        ...
        function discount_const_total_factor() {
            ...
            $('#discount_all_factor').addClass('readonly')
            $('#discount_all_factor_const').removeClass('readonly')
        }
